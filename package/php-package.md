...
| [dompdf/dompdf](https://github.com/dompdf/dompdf) | Dompdf是一个HTML,PDF转换器。 |
| [KnpLabs/snappy](https://github.com/KnpLabs/snappy) | PDF转换HTML |
| [iamcal/php-emoji](https://github.com/iamcal/php-emoji)|这是一个处理Emoji表情包的PHP库,允许您在各种原生格式之间进行转换显示在HTML页面。
| [paquettg/php-html-parser](https://github.com/paquettg/php-html-parser) | PHPHtmlParser是一种简单、灵活、html解析器,允许您选择使用任何css选择器,语法类似jQuery。|
| [KnpLabs/snappy](https://github.com/KnpLabs/snappy) | PDF转换HTML |
